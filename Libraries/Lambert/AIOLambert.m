function [V1,V2,TOF] = AIOLambert(T1,R1,V1,T2,R2,V2,Method,tollerance,EPH,Center,mu)
                                  
%All in one Lambert Function
% AerE 551, fall 2020
% Ryan Kirmeier
% Lambert's Problem:
% digits (16);
...
%   Center = 'SolarSystem';
%  %Starting/End Time:
%     T1 = datetime(2020,10,10);       	%[yyyy/mm/dd] Launch Date  (2021,03,21)
%     T2 = datetime(2021,06,30);        	%[yyyy/mm/dd] Arival Date  (2021,11,30)
% %  %Bodies:
% %    %Sun:
...
% %          Body.P2= matsolv(Body.P2,ICR2_TRANS1)*10^3; 
% %          Body.V2= matsolv(Body.V2,ICR2_TRANS1)*10^3;
% %             
% %          [~, Body.Initial] = rv2orb(Body.P1, Body.V1, mu,Pram); 
% %          [~, Body.Final  ] = rv2orb(Body.P2, Body.V2, mu,Pram);
